...
INSERT INTO SOCIOS (nombre, apellido, legajo, extranjero, baja, num_doc, correo, telefono, usuario_id, localidad_id, fecha_alta, tipo_documento_id, estado_civil_id, tipo_id, variable_id ) VALUES ('mariano', 'fuhr', 33245, FALSE, FALSE, '35356600', 'mfuhr@gmail.com', '290123234', 2, 1, '2020/12/08', 1, 1,1, 1);
INSERT INTO USUARIOS (nombre_usuario, contrasena, authority_id ) VALUES ('plopez', 'lopez', 2);
INSERT INTO SOCIOS (nombre, apellido, legajo, extranjero, baja, num_doc, correo, telefono, usuario_id, localidad_id, fecha_alta, tipo_documento_id, estado_civil_id, tipo_id, variable_id ) VALUES ('pedro', 'perez', 132345, FALSE, FALSE, '35356600', 'mfuhr@gmail.com', '290123234', 3, 1, '2020/12/25', 1, 1,1, 1);
